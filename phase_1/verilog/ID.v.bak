module ID #(parameter width = 16) (
    instruction, RW_sig_out, aluSrc_sig, MemWR_sig, MemR_sig, RW_Sig_in, Reg_data, aluOp_sig, op1, R_op2, I_op2, RW_Out_addr, RW_In_addr
  );
  input [width - 1 : 0] instruction;
  wire [2 : 0] read_addr1, read_addr2;
  ...
  assign read_enable = 'b1;
  assign RW_Out_addr = instruction[width - 12 : width - 14];
